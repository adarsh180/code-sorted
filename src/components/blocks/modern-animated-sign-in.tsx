...
type AnimatedFormProps = {
  ...
  googleLogin?: string;
  adminLogin?: { label: string; onClick: () => void };
  ...
  return (
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
        ...
        <>
          ...
          >
            <button
              ...
              type='button'
              onClick={() => {
                // Find and click the hidden Google action form button
          ...
          {adminLogin && (
            ...
            >
              <button
                className='g-button mt-2 group/btn bg-transparent w-full rounded-md border h-10 font-medium outline-hidden hover:cursor-pointer'
                type='button'
                onClick={adminLogin.onClick}
              >
          ...
          <BoxReveal boxColor='var(--skeleton)' duration={0.3} width='100%'>
            <section className='flex items-center gap-4 py-2 mt-2'>
      ...
      <form onSubmit={handleSubmit}>
              ...
              >
                <section className='relative'>
                  <Input
                    ...
                    name={field.label.toLowerCase().includes('name') ? 'name' : field.label.toLowerCase()}
                  />
        ...
        {footerNode && (
          <BoxReveal width='100%' boxColor='var(--skeleton)' duration={0.3} className="mb-4">
            {footerNode}
          </BoxReveal>
        )}
