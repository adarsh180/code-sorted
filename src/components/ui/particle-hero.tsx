...
export function ParticleHero() {
  ...
  return (
    <div
      className={`relative min-h-screen w-full overflow-hidden ${isGoldMode ? "gold-mode" : ""}`}
      style={{ 
    ...
    >
      ...
      {/* Hero */}
      <div
        className="hero mx-auto max-w-3xl flex justify-center mt-60 h-[300px] pointer-events-none relative z-10"
      >
        <div
          className="heroT"
          style={{
      ...
      >
        The world&apos;s best platform for Learning, <br />
        powered by CodeSorted
      </p>
